...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar,IonText,IonGrid,IonRow,IonCol, CommonModule, FormsModule,GeneralHeaderComponent,SeeAllComponent,Horizontal1CardComponent]
})
